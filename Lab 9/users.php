            ...
            if(isset($_FILES['uavtr'])){
                ...
                if($size<3000000){
                    ...
                    if($actualFormat=='jpg'||$actualFormat=='jpeg'){
                        ...
                        $resizedImage= imagescale($img, new_width:300,new_height:200);
                        imagejpeg($resizedImage,$location,quality:-1);
                    } elseif($actualFormat=='png'){
                        $img= imagecreatefrompng($tmpName);
                        $resizedImage= imagescale($img, new_width:300,new_height:200);
                        imagepng($resizedImage,$location,quality:-1);
                    } elseif($actualFormat=='gif'){
                        $img= imagecreatefromgif($tmpName);
                        $resizedImage= imagescale($img, new_width:300,new_height:200);
                        imagegif($resizedImage,$location,quality:-1);
                    }
                    $sq .="avatar='$location',";
                } else{
                ...
                <div class="table_container">
                    ...
                    <div class="table-responsive">
                        <table class="table table-dark" id="table" data-toggle="table" data-search="true" data-filter-control="true" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                            ...
                            <tr>
                                <th data-field="date" data-filter-control="select" data-sortable="true" style="color: #282828; text-align: center;">User</th>
                                <th data-field="examen" data-filter-control="select" data-sortable="true" style="color: #282828; text-align: center;"> Email</th>
                                <th data-field="note" data-sortable="true" style="color: #282828; text-align: center;">Last Login Time</th>
                            </tr>
                            </thead>
