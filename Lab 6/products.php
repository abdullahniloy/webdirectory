...
<html>
    ...
    <body>
        <div class="row" style="padding-top: 50px;">
                    ...
                    <section style="padding-left: 20px; padding-right: 20px;">
                        <div class="col-sm-3">
                            <div class="card card-green">
                                <h3 style="color: #282828; text-align: center;">Total Products </h3>
                    ...
                    <div class="table_container">
                        ...
                        <div class="table-responsive">
                            <table class="table table-dark" id="table" data-toggle="table" data-search="true" data-filter-control="true" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                ...
                                <tr>
                                    <th data-field="name" data-filter-control="select" data-sortable="true" style="color: #282828; text-align: center;">Product Name</th>
                                    <th data-field="bought" data-filter-control="select" data-sortable="true" style="color: #282828; text-align: center;"> Bought</th>
                                    <th data-field="sold" data-sortable="true" style="color: #282828; text-align: center;">Sold</th>
                                    <th data-field="stock" data-sortable="true" style="color: #282828; text-align: center;">Available in Stock</th>
                                    <th data-field="actions" data-sortable="true" style="color: #282828; text-align: center;"> Actions</th>
                                </tr>
                                </thead>
                                <tbody style="color: #282828; text-align: center;">
                                    <?php
            ...
            <div class="rightcolumn" style="color: #282828; text-align: center;">
                <div class="card">
                    <h2>About Us</h2>
